...
function validacion(){
    ...
    let normalBooking = document.getElementById('normalBooking'); //Getter
    let birthdayBooking = document.getElementById('birthdayBooking'); //Getter
    let otherBooking = document.getElementById('otherBooking'); //Getter
  ...
  if (!normalBooking.checked && !birthdayBooking.checked && !otherBooking.checked) {
  ...
  /*Comento esta ultima parte porque el check no funciona, he comprobado varias
  maneras y aun asi nada, asi que he decidido, para que el resto funcione,
  desactivar la comprovación.*/
